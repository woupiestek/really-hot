...
there are $a\of\base(C)\to A$ and $b\of\base(C)\to B$ such that 
\begin{align*}
...
\begin{remark} The class $M$ is closed under $C_*$ and $C^*$ since the class $M$ is assumed to be closed under all the necessary constructs. \end{remark}
