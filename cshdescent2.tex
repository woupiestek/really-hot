...
\begin{proof} 
The object of lifting problems $P$ is $\hom_{\set\geq}(\horn_{\set\geq},V)$. There is an indexed coproduct of horn inclusions $k_P\of \horn_P\to\simplex_P$. The object $V$ is fibrant if and only if the canonical morphism $v\of\horn_P\to V$ factors through $k_P$, because such a factorization solves all the lifting problems.\hide{Explain how this is constructed?}
...
The adjunction arises form a \emph{cosimplicial object} %cosimplicial
