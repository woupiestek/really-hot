...
\begin{proof}
The basic intuition is that categories of presheaves have all limits and colimits that are indexed over the category $\ambient$. As shown below the ordinary constructions of the left and right adjoints of the reindexing functors work here.
