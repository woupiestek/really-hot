...
If $\ambient$ is the topos of sets, then the morphisms that satisfy this definition are precisely the \emph{Kan fibrations}. In that case the axiom of choice implies a filler operator exists.
...
\begin{example} All discrete simplicial object has a canonical filler operator, which means that $\function{I\of\ambient}{I\disc}$ factors through the category of complexes. All simplices are complexes. Horns are not.
\end{example}
