...
If we have $\tuple{i,j,f}$ and $\tuplet{i,k,g}$, then we need a pushout $\tuplet{i,l,h}$. With those pushouts, the density comonad of $c$ reduces to $a$. Because $h$ is the diagonal in the pushout of $f$
