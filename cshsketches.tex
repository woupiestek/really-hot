...
Note that Reedy factorization is quite complicated, and the paper tries skips to the result.
...
It is good to look up the definitions again, if only for the confirmation that the proof in the paper is not more complication than necessary.
