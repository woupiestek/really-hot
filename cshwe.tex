...
The reason the dual reasoning works is that for the cycles $\cycle[n]$ from definition \ref{contractible} the unique morphism $\bang\of 0\to \cycle[n]$ is a cofibration. Here $0=0\disc$ is the initial object of $\ambient\s$. A member of $\base(\cycle[n])$ is a face if it is an identity morphism, and this is a decidable property of morphisms in $\simCat$. No faces are in the image of $\bang$.
\end{proof}
