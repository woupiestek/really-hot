...
%do we really want to proceed with this last bit, or are the 'simplicial sets' we defined earlier better?
\end{enumerate}
...
Internal languages only quantify over objects and $\cat S$ does not have an object of $a$-injectives does not exist inside $\cat S$. The definition of $a$-anodynes therefore requires the ambient category $\ambient$.
