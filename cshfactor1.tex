...
\begin{proof}
%todo: this needs more work to be convincing.
...
\hide{\begin{proposition} A morphism has the left lifting property with respect to all contractible morphisms if and only if it is a cofibration. \label{cofibration characterization} \end{proposition}

\begin{proof} Factor any morphism $f\of X\to Y$ as in the proof of lemma \ref{factor1} to get a cofibration $g\of X\to Z$ and a contractible $h\of Z\to Y$. Because $\id_Y\circ f = h\circ g$ there is a $k\of Y\to Z$ such that $h\circ k = \id_Y$ and $k\circ f = g$ by the lifting property.
\[
\xymatrix{
